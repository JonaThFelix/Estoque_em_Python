#Projeto realziado para atender o Inter de 2023.1 do curso de ADS / Unibra
#Turma 2022.2
#Akhenaton | @hiperbolante


import time

print("SISTEMA DE ESTOQUE DA DONA (NOME) \n")
...
def cadastro():
    ...
    login = "unibra" #senha definida
    senha = "unibra" #senha definida
...
def printar_dados():
    ...
    print("Data de Fabricação: ",data_produto_lista[exibir_produto_codigo] ) ###
...
data_produto_lista = [] ####
data_produto_lista_antiga_lista = []
data_produto_lista_saida_lista = []
data_produto_lista_entrada_lista = []
...
#   #   #Menu para cadastrar um novo produto #1.1
            if (menu_cadastrar_produto == "1"):
                ...
                while True:
                    ...
                    #Adicionar data do produto a uma lista
                    while True: ##
                        modelo_data_digitado = (input("Digite a data de fabricação: "))

                        if(modelo_data_digitado == ""):
                            print("Data Inválida!")
                            print("-------------\n")

                        else:
                            data_produto_lista.append(modelo_data_digitado)
                            break
